...
describe('Токенизация', () => {
  ...
  // it('При заходе на защищеный маршрут с верным токеном получаем 200', async () => {
  //   const result = await request(app)
  //     .get('/screens/home')
  ...
  // });
  it('При заходе на защищеный маршрут с просроченым токеном получаем 403 и объект ошибки', async () => {});
  it('При заходе на защищеный маршрут с отсутствующим токеном получаем 403 и объект ошибки', async () => {});
  it('При заходе на защищеный маршрут с неверным токеном получаем 403 и объект ошибки', async () => {});
  ...
  it('При рефреше с неверным рефреш токеном получаем 403 и объект ошибки', async () => {});
});
